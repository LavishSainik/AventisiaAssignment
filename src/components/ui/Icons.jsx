// Sidebar and UI icons — matched to Figma design pixel by pixel
...
// ── sidebar nav icons (redesigned to match Figma) ──

// Agents — robot/bot head with antenna nubs
...
// AI Models — chip/processor with circuit lines
export function AIModelsIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
// Machines — desktop monitor with stand
...
// Executions — terminal/code screen with brackets
export function ExecutionsIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <rect x="2" y="3" width="20" height="14" rx="2" />
...
// Knowledge Base — card layout with grid sections
...
// Key Store — vertical bar chart
export function KeyStoreIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
// Tenant — person inside a badge/card frame
...
// Credit Usage — credit card
export function CreditUsageIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
